...
.DESCRIPTION
  This script allows you to find and manage empty security and distribution groups within your AD environment. This script also allows
...
.EXAMPLE
  Execution of script using default parameters. Default execution performs reporting of empty AD groups only, not deleting any objects.
...
.EXAMPLE
  ...
  .\Find-ADEmptyGroups.ps1 -SearchScope "OU=GROUPS,DC=testlab,DC=com" -ReportFilePath 'C:\Reports\DeletedGroups.csv' -DeleteObjects
#>
